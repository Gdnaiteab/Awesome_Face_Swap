...
| Title                                                        |   Venue   |                           Dataset                            |                             PDF                              |                           CODE                           |
| :----------------------------------------------------------- | :-------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :------------------------------------------------------: |
| DiffSwap: High-Fidelity and Controllable Face Swapping via 3D-Aware Masked Diffusion | CVPR2023  |  **Train：**<br />FFHQ<br />**Eval:**<br />FaceForensics++   | [PDF](https://openaccess.thecvf.com/content/CVPR2023/papers/Zhao_DiffSwap_High-Fidelity_and_Controllable_Face_Swapping_via_3D-Aware_Masked_Diffusion_CVPR_2023_paper.pdf) |       [CODE](https://github.com/wl-zhao/DiffSwap)        |
...
|:---------: |:---------:|:---------------------------------:|
| <center>FaceFusion(Unlocked)</center> | [FaceFusion](https://github.com/hassan-sd/facefusion-unlocked) | **FaceFusion** is a face swapper and enhancer. This edition has removed the NSFW checker. |
